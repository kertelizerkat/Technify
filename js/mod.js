...
function extract4(){
      ...
      function renderSlips(category) {
        ...
        if (!slips || slips.length === 0) {
          ...
          empty.textContent = "No slips in this category.";
        ...
        if (data.message) {
          ...
          for (r in cards_data) {
            if (cards_data[r].state == 'live') {
              liveco++
              r_data_live = r_data_live + `  <div   class="relative _move_2 rounded-2xl shadow-xl bg-cover bg-center min-h-[320px] flex flex-col justify-between p-4 text-gray-900 animate-fade-in" >
        ...
        <div class="bg-white/80 w-full h-full p-4 flex flex-col justify-between backdrop-blur-sm rounded-2xl">
          ...
          <div class="grid grid-cols-3 gap-2">
            ...
            if (cards_data[r].state == 'upcoming') {
              upco++
              r_data_upcoming = r_data_upcoming + `  <div class="relative _move_2 rounded-2xl shadow-xl bg-cover bg-center min-h-[320px] flex flex-col justify-between p-4 text-gray-900 animate-fade-in" >
        <div class="bg-white/80 w-full h-full p-4 flex flex-col justify-between backdrop-blur-sm rounded-2xl">
          <div class="mb-3">
            <h2 class="text-xl font-bold text-indigo-600 mb-1">${cards_data[r].type_}</h2>
            <div class="flex flex-wrap items-start justify-between gap-2 sm:flex-nowrap mb-2">
