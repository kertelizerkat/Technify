    ...
    if (pasw && phone && usern && email && logged=='true'){
        ...
        if (!(pstate=='cost' || pstate=='login' || pstate=='verify' || pstate=='register' || pstate=='BTS'|| pstate=="logged")){window.location.assign('../logged')};
           ...
           let iconm= document.getElementById('iconm')
            document.getElementById('ot1').textContent='About'
            document.getElementById('ott1').textContent='About'
            document.getElementById('ot3').textContent='📊 Dashboard'
            document.getElementById('Dashboard').textContent='Main'
            document.getElementById('Dashboard').setAttribute('href','../../index.html')
            document.getElementById('ott1').setAttribute('href','../../about/index.html')
            document.getElementById('ott2').setAttribute('href','../../services/index.html')
            document.getElementById('iconm').setAttribute('src','../../favicon.ico')
            document.getElementById('ot2').textContent='Services'
            document.getElementById('ott2').textContent='Services'
            // document.getElementById('Dashboard').style.display='none'
           
           if (ll1){
            ll1.textContent='Sign up'
            ll1.setAttribute('onclick','register()')
           }
           if (ot4){
            ot4.textContent='Sign up'
            if (ll2){
