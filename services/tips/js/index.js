let dmcon = accessInfo("domcontent3")
let givendt = accessInfo('domContentdate3')
let pmain_state = accessInfo('main_state3')
let ons= accessInfo('online')
if (givendt) {
    checkTimeDifference(givendt, onThresholdMet);
}
if (dmcon && ons=='true' && false) {
...
function saveDOMBeforeReload() {
    window.addEventListener('beforeunload', function () {
        try {
            ...
            localStorage.setItem('domContent3', domContent);
            localStorage.setItem('domContentdate3', exampleDate);
            localStorage.setItem('main_state3', main_state);
